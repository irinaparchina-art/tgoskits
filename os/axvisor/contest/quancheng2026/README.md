...
- Final submission checklist: `docs/final-submission-checklist.md` records the remaining commit, core-patch, demo-video and platform-submission gates.
...
docs/
  ...
  final-submission-checklist.md       Remaining commit, PR, demo and platform gates.
